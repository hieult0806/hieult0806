...
*Python · Blender API · UV & Texture Workflows*

A community fork bringing TexTools to Blender 5.x. My changes adapt UV selection to the new API, update Color ID operations to write mesh color attributes directly, and address Python 3.13 warnings. UV, baking, and Color ID workflows were tested on Blender 5.1.
